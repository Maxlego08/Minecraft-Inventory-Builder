...
/**
 * This class represents a single Code tag.
 * It is just a simple class used for storing tag.
 *
 * @package ChrisKonnertz\Code
 */
class Tag
{
    ...
    /**
     * Position of this tag inside the whole Code string
     *
     * @var int
     */
    public $position = -1;
     ...
     */
    public function __construct(string $name = null, bool $opening = true)
    {
