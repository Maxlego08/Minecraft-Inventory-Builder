    ...
    <div class="d-flex flex-wrap flex-lg-nowrap">
        ...
        <div class="block_resources_end d-flex align-items-center justify-content-end flex-grow-1 fs-7">
            ...
            <ul class="navbar-nav">
                ...
                <li class="py-1"><span>{{ __('messages.downloads') }}</span> <span>{{ $resource->countDownload() }}</span></li>
                <li class="py-1"><span>{{ __('messages.updated') }}</span> <span>{{ format($resource->created_at) }}</span>
                </li>
            </ul>
        </div>
    </div>
