 ...
 *
 * @firepower SCEditor Code Format
 * @author Sam Clarke
 */
(function (sceditor) {
    ...
    const getEditorCommand = sceditor.command.get;
    ...
    const defaultCommandsOverrides = {
        bold: {
            txtExec: ['[b]', '[/b]']
        },
        italic: {
    ...
    const bbcodeHandlers = {
        ...
        url: {
            ...
            quoteType: QuoteType.never,
            format: function (element, content) {
                let url = attr(element, 'href');

                // make sure this link is not an e-mail,
                // if it is return e-mail Code
    ...
    function BBCodeParser(options) {
        ...
        /**
         * Takes a Code string and splits it into open,
         ...
         *
         * Removes any formatting new lines from the Code
        ...
        /**
         * Converts a Code string to HTML
         *
         * @param {string} str
         * @param {boolean}   preserveNewLines If to preserve all new lines, not
         *                                  strip any based on the passed
        ...
        /**
         * Takes a Code string, parses it then converts it back to Code.
         *
         * This will auto fix the Code and format it with the specified
         * options.
         *
         * @param {string} str
         * @param {boolean} preserveNewLines If to preserve all new lines, not
        ...
        /**
         * Converts parsed tokens back into Code with the
        ...
        function convertToBBCode(toks) {
            ...
            while (toks.length > 0) {
                ...
                if (!bbcode && token.type === TOKEN_OPEN) {
                    ...
                    // Convert the tag and it's attributes to Code
                    ret += '[' + token.name;
                    if (token.attrs) {
                    ...
                    // Convert the tags children to Code
                    if (token.children) {
                        ret += convertToBBCode(token.children);
                    }
    ...
    function bbcodeFormat() {
        ...
        /**
         * Converts a HTML dom element to Code starting from
            ...
            var toBBCode = function (node, vChildren) {
                ...
                dom.traverse(node, function (node) {
                    ...
                    if (nodeType === 1) {
                        ...
                        // valid children bbcodes instead by creating Code
    ...
    /**
     * Adds a Code to the parser or updates an existing
     * Code if a Code with the specified name already exists.
     *
     * @param {string} name
     * @param {Object} bbcode
     * @return {this}
