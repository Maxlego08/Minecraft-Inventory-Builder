(function () {
    ...
    var defaultOptions = {
        ...
        /**
         * If to trim the Code. Removes any spaces at the start and end of the
         * Code string.
         *
         * @type {boolean}
         */
        ...
        /**
         * Code parser options, only applies if using the editor in Code
         * mode.
         *
    ...
    function SCEditor(original, userOptions) {
        ...
        /**
         * Editor format like Code or HTML
         */
        var format;
         ...
         * HTML from it (converted to Code if using the Code plugin).
         * It it's in Source Mode it will return the unfiltered contents
         * of the source editor (if using the Code plugin this will be
         * Code again).
         *
         * @since 1.3.5
         * @return {string}
         ...
         * function. If using the Code plugin it will pass the val to
         * the Code filter to convert any Code into HTML.
         *
         * @param {string} val
         ...
         *
         * If the filter param is set to true, the HTML/Code will be
         * passed through any plugin filters. If using the Code plugin
         * this will convert any Code into HTML.
         *
         * @param {string} start
         ...
         *
         * If using a plugin that filters the Ht Ml like the Code plugin
         * it will return the result of the filtering (Code) unless the
         ...
         *
         * If using a plugin that filters the text like the Code plugin
         * it will return the result of the filtering which is Code to
         * HTML so it will return HTML. If filter is set to false it will
         * just return the contents of the source editor (Code).
         *
         * @param {boolean} [filter=true]
         * @return {string}
         * @function
     ...
     *
     * @fileoverview SCEditor - A lightweight WYSIWYG Code and HTML editor
     * @author Sam Clarke
     */
