...
const InventoryVisibility = ({inventory, updateInventory}) => {
    ...
    const visibilityTypes = {
        ...
        3: {
            label: "Public",
            icon: "bi-globe-americas text-success",
    ...
    return (
        <>
            ...
            <VisibilityModal show={modalShow} onClose={handleModalToggle}
                             inventoryVisibility={visibility.label.toLowerCase()}
